function evalRouletteBet(bet, number, color) {
    ...
    if (selectedNumber !== undefined && selectedNumber >= 0 && selectedNumber <= 36) {
        ...
        else if (outside === 'second12') {
            win = number >= 13 && number <= 24;
            multiplier = 3;
        }
        else if (outside === 'third12') {
        ...
        else if (outside === 'row1') {
            win = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36].includes(number);
            multiplier = 3;
        }
        else if (outside === 'row2') {
            win = [2, 5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35].includes(number);
            multiplier = 3;
        }
        else if (outside === 'row3') {
            win = [1, 4, 7, 10, 13, 16, 19, 22, 25, 28, 31, 34].includes(number);
            multiplier = 3;
        }
    }
    else {
