...
export const SYMS: SymbolDef[] = [
	...
	{ id: 2, name: 'Husky', w: 2.2, pays: [2, 10, 50] },
	{ id: 3, name: 'Boxer', w: 2.6, pays: [1.5, 8, 40] },
	{ id: 4, name: 'Bulldog', w: 3.4, pays: [1.2, 6, 30] },
	{ id: 5, name: 'Dalmatian', w: 4.2, pays: [1, 4, 20] },
	{ id: 6, name: 'Terrier', w: 5, pays: [0.8, 3, 15] },
