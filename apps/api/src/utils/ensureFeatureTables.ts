...
const STATEMENTS: Array<string> = [
	...
	`ALTER TABLE "ExchangeRequest" ADD COLUMN IF NOT EXISTS "kind" TEXT NOT NULL DEFAULT 'SELL'`,
	`ALTER TABLE "ExchangeRequest" ADD COLUMN IF NOT EXISTS "minGc" BIGINT NOT NULL DEFAULT 0`,
	`ALTER TABLE "ExchangeRequest" ADD COLUMN IF NOT EXISTS "maxGc" BIGINT NOT NULL DEFAULT 0`,
	`ALTER TABLE "ExchangeRequest" ADD COLUMN IF NOT EXISTS "minRubMinor" BIGINT NOT NULL DEFAULT 0`,
	`ALTER TABLE "ExchangeRequest" ADD COLUMN IF NOT EXISTS "maxRubMinor" BIGINT NOT NULL DEFAULT 0`,
