...
// Очистка старых строк: бесплатный Neon даёт 0.5 ГБ, а каждый спин пишет
// строку в кошелёк и строку истории игры. Без подрезки место кончается через
// пару сотен тысяч спинов, и база просто перестаёт принимать запись.
//
